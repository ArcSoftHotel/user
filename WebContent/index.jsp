                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">欢迎来到虹软酒店</h1>
                    ...
                    <div class=" col-xl-4 col-lg-4">
                        <div class="customer-caption">
                            ...
                            <div class="caption-details">
                                <p class="pera-dtails">这是我们的宗旨</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. </p>
                                <a href="#" class="btn more-btn1">更多 <i class="ti-angle-right"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="room-area">
            <div class="container">
                ...
                <% RoomDAO roomdao = new RoomDAO(); 
					   ...
					   for(Room room:rl){
						   if(i==6) break;
						   else if(!room.getState().equals("空闲")) continue;
						   else{
							   	i++;
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="room.jsp" class="btn view-btn1">更多  <i class="ti-angle-right"></i> </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-8 col-md-8">
                            <div class="dining-caption">
                                <span>我们的餐厅</span>
                                <h3>食物  & 饮品</h3>
                                <p>我们提供优质的餐厅服务,<br>我们的食物严选上等的食材,<br>您将拥有愉快的用餐体验。</p>
                                <a href="User_ShoppingCart.jsp" class="btn border-btn">去点餐 <i class="ti-angle-right"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-8 col-md-8">
                            <div class="dining-caption text-right">
                                ...
                                <a href="sport.jsp" class="btn border-btn">去预约  <i class="ti-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="font-back-tittle mb-105">
                                    ...
                                    <h3 class="archivment-back">关于我们</h3>
                                </div>
                                 <!-- Testimonial Content -->
